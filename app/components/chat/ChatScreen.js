                ...
                <div className="flex items-center flex-1 min-w-0">
                    <div className="relative">
                        ...
                        {onlineUsers.includes(conversation.id) && (
                            <span className="absolute -top-1 w-3 h-3 bg-green rounded-full border-2 border-white dark:border-gray-900" />
                        )}
                    </div>
            ...
            <form onSubmit={handleSubmit} className="p-4">
                <div className="flex space-x-2">
                    <input
                        ...
                        className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-text-secondary-light dark:focus:ring-text-tertiary-light bg-light dark:bg-dark-accent text-text-secondary-dark dark:text-text-primary-light"
                    />
                    <button
                        type="submit"
