        ...
        <div className="relative flex-1" ref={searchRef}>
            <div className="relative">
                <input
                    ...
                    className="w-full px-4 py-2 pl-10 text-sm text-gray-700 bg-light-accent dark:bg-dark-accent border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-300 dark:border-gray-600"
                />
                <svg
