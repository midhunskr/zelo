    ...
    return (
        <div className='h-full'>
            {conversations.length === 0 ?
                ...
                :
                <div className="space-y-4 p-5 bg-inner-surface-light dark:bg-inner-surface-dark md:bg-light md:dark:bg-dark-accent
                ...
                border border-card-stroke-light dark:border-card-stroke-dark md:border-none">
                    ...
                    <div className='overflow-y-auto flex flex-col gap-4 max-h-[12vh] xs:max-h-[26.5vh] lg:max-h-[14vh]
                    xl:max-h-[32vh] scroll-smooth scrollbar-thumb-text-secondary-light
